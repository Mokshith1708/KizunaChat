...
const getSeenMessage = (messageId: Id<"messages">)=>{
  ...
  return (
    <div className='flex-1 w-full flex overflow-y-scroll flex-col-reverse gap-2 p-3 no-scrollbar' style={{ backgroundImage: `url('/images.jpeg')` }}>{messages?.map(({message, senderImage, senderName, isCurrentUser}, index) => {
